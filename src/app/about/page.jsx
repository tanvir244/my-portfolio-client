            ...
            <div className='w-[90%] md:max-w-6xl mx-auto min-h-screen text-white'>
                ...
                <div className='flex flex-col md:flex-row gap-8 my-12'>
                    ...
                    <div className='text-white w-full md:w-[70%] p-4'>
                        ...
                        <p className='text-[#fefae0]'>I'm Tanvir Rahman, living in Uttara, Dhaka, Bangladesh. I am currently working with JavaScript technologies like Next.js, React.js, Node.js, and Express.js to build scalable full-stack applications. I'm also focusing on vanilla JavaScript to deepen my understanding. Throughout my extensive journey, I have developed several serious projects using Vanilla JS, Next.js, and React.js, integrating the server side with databases. Academically, I'm a first-year bachelor’s student studying Economics at the National University of Bangladesh.</p>
